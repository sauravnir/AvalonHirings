...
function NavigationDashboard() {
  ...
  return (
    <nav class="sticky top-0 relative z-0 justify-between">
      <div class="fixed w-full z-30 flex bg-gray-50 dark:bg-gray-50 p-2 items-center shadow-lg justify-end h-14 px-10">
        <div class="flex h-full text-center flex items-center justify-center">
          <div class="flex flex-row space-x-5 items-center ">
            <h1 class='hover:underline'>Saurav Niraula</h1>
            <Dropdown
              menu={{
                items,
              }}
